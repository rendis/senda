...
stop_frontend_dev() {
  stop_managed_frontend "$FRONTEND_PID_FILE" "ui-template-type-slug-edit"
}
...
start_frontend_dev() {
  start_managed_frontend "$FRONTEND_PID_FILE" "$FRONTEND_LOG_FILE" "ui-template-type-slug-edit"
}
