...
export function AppSidebar({
  ...
  const navItems = [
    ...
    { label: t("templates"), icon: FileText, href: "/templates", vis: { global: false, system: true, workspace: true } },
    { label: t("injectors"), icon: Database, href: "/injectors", vis: { global: false, system: true, workspace: true } },
