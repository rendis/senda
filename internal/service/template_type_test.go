...
func TestTemplateTypeService_Create_Success(t *testing.T) {
	...
	desc := "Welcome emails"
	tt, err := svc.Create(context.Background(), "welcome-email", "Welcome Email", &desc, nil, nil, nil, nil, nil, false, &wsID)
	if err != nil {
...
func TestTemplateTypeService_Create_Global(t *testing.T) {
	...
	tt, err := svc.Create(context.Background(), "password-reset", "Password Reset", nil, nil, nil, nil, nil, nil, false, nil)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestTemplateTypeService_Create_DuplicateSlug(t *testing.T) {
	...
	_, err := svc.Create(context.Background(), "welcome-email", "Welcome", nil, nil, nil, nil, nil, nil, false, nil)
	if err == nil {
...
func TestTemplateTypeService_Create_StoreError(t *testing.T) {
	...
	_, err := svc.Create(context.Background(), "test-type", "Test", nil, nil, nil, nil, nil, nil, false, nil)
	if err == nil {
...
func TestTemplateTypeService_Create_WithAdapterAndSchema(t *testing.T) {
	...
	tt, err := svc.Create(context.Background(), "invoice", "Invoice", nil, &adapterID, nil, schema, nil, nil, false, nil)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
