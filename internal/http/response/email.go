...
type EmailResponse struct {
	...
	SourceActorMemberID *string  `json:"source_actor_member_id,omitempty"`
	SourceActorEmail    *string  `json:"source_actor_email,omitempty"`
...
func NewEmailResponse(e *domain.Email) EmailResponse {
	var sourceActorMemberID *string
	if e.SourceActorMemberID != nil {
		s := e.SourceActorMemberID.String()
		sourceActorMemberID = &s
	}
	return EmailResponse{
		...
		SourceActorMemberID: sourceActorMemberID,
		SourceActorEmail:    e.SourceActorEmail,
